...
* To think about:
  ...
  - Have weird levels of makefiles.
    make would only compile in container if host source file has changed since then.
    but, it is working properly now with dockerCompile
